...
SWIFT_CLASS_NAMED("EncodedRolloutAssignment")
@interface FIRCLSEncodedRolloutAssignment : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull rolloutId;
@property (nonatomic, readonly, copy) NSString * _Nonnull variantId;
@property (nonatomic, readonly) int64_t templateVersion;
@property (nonatomic, readonly, copy) NSString * _Nonnull parameterKey;
@property (nonatomic, readonly, copy) NSString * _Nonnull parameterValue;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS_NAMED("EncodedRolloutsState")
@interface FIRCLSEncodedRolloutsState : NSObject
@property (nonatomic, readonly, copy) NSArray<FIRCLSEncodedRolloutAssignment *> * _Nonnull rollouts;
- (nonnull instancetype)initWithAssignments:(NSArray<FIRCLSEncodedRolloutAssignment *> * _Nonnull)assignments OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
